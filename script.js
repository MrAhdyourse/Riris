...
new TypeIt("#teks2", {
  strings: ["Semoga semesta selalu membahagiakan kamu bagimanapun caranya.", " ", "barakallah fi umrik, Selamat Ulang Tahun yang ke-20 ya riris!", " ", "- Dari Ahdyours Doa terbaik Untuk riris"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
